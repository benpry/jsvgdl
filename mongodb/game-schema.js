...
GameSchema.statics.delete_description = function (
	game_name,
	desc_num,
	callback,
) {
	this.findOne(
		...
		(err, game) => {
			if (game) {
				...
				console.log(
					"Could not delete description. game was not found",
					game_name,
				);
			}
		},
...
var good_games = [
	"JRNL_avoidGeorge_v1",
	"JRNL_beesAndBirds_v1",
	"JRNL_boulderDash_v1",
	"JRNL_plaqueAttack_v1",
	"JRNL_portals_v1",
	"JRNL_preconditions_v1",
	"JRNL_pushBoulders_v1",
	"JRNL_relational_v1",
	"JRNL_watergame_v1",
];
